...
<a href="https://pkg.go.dev/github.com/TralahM/paymaxis-go"><img src="https://pkg.go.dev/badge/github.com/TralahM/paymaxis-go.svg" alt="Go Reference"></a>

The Paymaxis Go library provides convenient access to [the Paymaxis REST
API](https://docs.paymaxis.com) from applications written in Go. The full API of this library can be found in [api.md](api.md).
...
```sh
go get -u 'github.com/TralahM/paymaxis-go@v0.1.0-alpha.4'
```
...
See the [full list of request options](https://pkg.go.dev/github.com/TralahM/paymaxis-go/option).
...
`*paymaxis.Error`. This contains the `StatusCode`, `*http.Request`, and
...
We also provide a helper `paymaxis.FileParam(reader io.Reader, filename string, contentType string)`
...
We are keen for your feedback; please open an [issue](https://www.github.com/TralahM/paymaxis-go/issues) with questions, bugs, or suggestions.
