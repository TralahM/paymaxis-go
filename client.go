...
// interacting with the paymaxis API. You should not instantiate this client
...
// environment (PAYMAXIS_API_KEY). The option passed in as arguments are applied
// after these default arguments, and all option will be passed down to the
// services and requests that this client makes.
func NewClient(opts ...option.RequestOption) (r *Client) {
	defaults := []option.RequestOption{option.WithEnvironmentSandbox()}
	if o, ok := os.LookupEnv("PAYMAXIS_API_KEY"); ok {
